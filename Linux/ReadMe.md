...
## 3.4 고급 권한
|종류|사용|내용|file영향|dir영향|
|--|--|--|--|--|
|set uid|u+s|실행 권한이 있는 바이너리 파일/스크립트 파일만 사용|O|X|
|set gid|g+s||O|O|
|sticky bit|o+t||X|O|
...
*/5 1 5 3 * data >> file02 # 3월 5일 1시에 5분마다 실행

1,3,5 18 1-7 5 3 cal >> file02 # 5월 첫째주 수요일 18시 1분 3분 5분에 실행
```
